...
<div class="form-group">
  ...
  <div class="col-xs-6">
  <input id="lrn" name="lrn" type="text" placeholder="Enter ID " maxlength="12" class="form-control input-xs" required="">
  </div>
</div>
...
<div class="col-md-12" style="width:70%;border-bottom:1px solid #333">
<h4><b>Intermediate School Details </b></h4>
</div>
<br>
<br>
<div class="col-md-12">
<br>
<div class="form-group">
  <label class="col-xs-2 control-label" for="icc">School Completed</label> 
  <br>
  <div class="col-xs-6">
  <input id="icc" name="icc" type="text"
  style="text-transform: capitalize;"
   placeholder="Enter School Transfered From " class="form-control input-xs" required="">
  </div>
</div>
