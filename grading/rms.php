...
$page = $_GET['page'];
$pages = array('home', 'Students', 'subjects','student_p','records','record','project 2.1','addrecord','report','program','statistical','form137','list_report','student_report','users','school_year','grade','advisers','database','candidates','candidates_list','add_student_record', 'candidates_report','logs');
if (!empty($page)) {
